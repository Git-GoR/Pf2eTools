...
class AddMenuSpecialTab extends AddMenuTab {
	...
	render () {
		if (!this.$tab) {
			...
			const $wrpText = $(`<div class="ui-modal__row"><span>Basic Text Box <i class="text-muted">(Use the <b>embed</b> feature with Google Docs/Sheets for anything more than a notepad)</i></span></div>`).appendTo($tab);
